	...
	bool shadow, FontClass* Font, const char* text, int positionX, int positionY, float red, float green, float blue)
{
	...
	//result = m_Font->Initialize(device, "Resources/Fonts/fontdata.txt", L"Resources/Fonts/font.dds");
	//if (!result)
	//{
	...
	//result = InitializeSentence(&m_sentence9, 64, device);
	//if (!result)
	//{
	//	return false;
	//}

	//result = InitializeSentence(&m_sentence10, 64, device);
	//if (!result)
	//{
	//	return false;
	//}

	//result = InitializeSentence(&m_sentence11, 64, device);
	//if (!result)
	//{
	//	return false;
	//}

	//result = InitializeSentence(&m_sentence12, 64, device);
	//if (!result)
	//{
	//	return false;
	//}

	//result = InitializeSentence(&m_sentence13, 64, device);
	//if (!result)
	//{
	//	return false;
	//}

	//result = InitializeSentence(&m_sentence14, 64, device);
	//if (!result)
	//{
	//	return false;
	//}

	//result = InitializeSentence(&m_sentence15, 64, device);
	//if (!result)
	//{
	//	return false;
	//}
